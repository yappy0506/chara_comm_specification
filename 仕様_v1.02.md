...
- [キャラ演技LLM](#キャラ演技llm)
  ...
  - [2. システム詳細](#2-システム詳細)
    - [2.1. インタフェース](#21-インタフェース)
    - [2.2. キャラクター設定管理](#22-キャラクター設定管理)
      - [2.2.1. キャラクターの設定参照システム](#221-キャラクターの設定参照システム)
      - [2.2.2. 会話履歴管理システム](#222-会話履歴管理システム)
    - [2.3. LM Studio 接続仕様](#23-lm-studio-接続仕様)
    - [2.4. Config](#24-config)
